...
| Método   | Path                                        | Auth             | Service                           | Descrição                                                                                                                                                                                                                           |
| -------- | ------------------------------------------- | ---------------- | --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `GET`    | `/products`                                 | JWT              | `product.listProducts`            | Lista produtos; `externalRef`, `productKind`, agregados `variantCount`, `minEffectiveSaleCents`, `maxEffectiveSaleCents`. Query: `productKind` (`simple` \| `variable`), `q`, `status`, `productType`, …                            |
...
| `GET`    | `/products/lines`                           | JWT              | `product.findLines`               | Lista linhas de produto                                                                                                                                                                                                             |
| `GET`    | `/products/lines/:lineId/compositions`      | JWT              | `lineComposition.listByLine`      | Composição da linha                                                                                                                                                                                                                 |
| `POST`   | `/products/lines/:lineId/compositions`      | JWT              | `lineComposition.add`             | Adiciona componente à linha                                                                                                                                                                                                         |
| `PATCH`  | `/products/lines/compositions/:id`          | JWT              | `lineComposition.update`          | Atualiza composição da linha                                                                                                                                                                                                        |
| `DELETE` | `/products/lines/compositions/:id`          | JWT              | `lineComposition.archive`         | Arquiva composição da linha                                                                                                                                                                                                         |
...
| `GET`    | `/products/:id`                             | JWT              | `product.findById`                | Retorna produto com variantes (inclui `externalRef`)                                                                                                                                                                                |
| `GET`    | `/products/:id/detail`                      | JWT              | `product.getOperationalDetail`    | Vista operacional: produto, composições, filhos, custo, **`variants`** (com `attributes`, `externalRef` PRV-…)                                                                                                                      |
| `GET`    | `/products/:id/variants`                    | JWT              | `product.listVariants`            | Lista variações (vazio se `productKind` simples)                                                                                                                                                                                    |
| `PATCH`  | `/products/:id/variants/:variantId`         | JWT              | `product.updateVariant`           | Corpo parcial (Zod `updateProductVariantSchema`)                                                                                                                                                                                    |
| `POST`   | `/products/:id/variants/:variantId/archive` | JWT              | `product.archiveVariant`          | Arquiva variação                                                                                                                                                                                                                    |
| `POST`   | `/products/:id/variants/:variantId/restore` | JWT              | `product.restoreVariant`          | Restaura variação arquivada                                                                                                                                                                                                         |

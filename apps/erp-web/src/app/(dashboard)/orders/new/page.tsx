...
export default async function NewOrderPage({
  ...
  let customers: Row[] = [];
  try {
    const res = await erpApiFetch<{ data: Row[] }>({ path: "/customers", searchParams: { limit: 100 } });
    customers = res.data;
  } catch {
    customers = [];
  }
  ...
  return (
    <div className="flex flex-col overflow-auto">
      ...
      <div className="p-6">
        <Link href="/orders" className="mb-4 inline-block text-sm text-zinc-600 hover:text-zinc-900">
          ← Voltar
        </Link>

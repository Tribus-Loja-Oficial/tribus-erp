    ...
    <div className="flex flex-col overflow-auto">
      ...
      <div className="flex flex-1 flex-col gap-6 p-6">
        <p className="text-sm text-zinc-600">
          Uma BOM (Bill of Materials) define quais insumos e quantidades são necessários para
          produzir um produto. Ao criar uma ordem de produção, o sistema usa a BOM ativa para
          reservar os materiais automaticamente.
        </p>
        ...
        <div className="mx-auto w-full max-w-lg rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
          ...
          <p className="mt-1">
            Use a API <code className="rounded bg-amber-100 px-1">POST /production/bom</code> com o
            produto, versão e lista de insumos. A BOM ativa será usada automaticamente ao criar uma
            ordem de produção.
          </p>
        </div>
      </div>
